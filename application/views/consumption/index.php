<!DOCTYPE html>
    ...
    {                                                                   for($i=0;$i < $count_site;$i++){
        if($user_sites[$i] == $site->sid ){ ?>
                                          ...
                                          <div  class="row">
                                        <div class="col-md-8">                                                
                                        <form enctype="multipart/form-data" action="<?php echo base_url()?>consumption/select_by_date_range" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    ...
    echo '<font style="font-size:16px;" color="red">'.$this->session->flashdata('add_message').'</font>';
                                                ...
                                                <div class="message">
                                                    ...
                                                    if (isset($result_display_date))
                                                    {
                                                        ...
                                                        { ?>
                                                    <form method="post" action="<?php echo base_url()?>Consumption/select_by_date_range_action">
