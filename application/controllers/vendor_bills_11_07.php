...
class Vendor_bills_11_07 extends CI_Controller {
    ...
    public function index() {
		...
		//$data['sites'] = $this->db->select("SELECT * FROM `sitedetails` JOIN users ON sitedetails.sid = users.site WHERE users.uid = 11");
    ...
    public function insert()
    {
        ...
        redirect('vendor_bills/view_table');
    }
