    ...
    <body>
        <div id="main">
            ...
            <div id="show_form">
                ...
                ?>
<!--
                <form action="select_by_date_range">
                    <input type="date" name="date_from" placeholder="yyyy-mm-dd" required>
                    <input type="date" name="date_to" placeholder="yyyy-mm-dd" required>
                    <input type="submit" name="Show Record"  value="Show Record">
                </form>
-->
                <div class="message">
                    <?php
