              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a href="<?php echo base_url().$controller;?>/form"><button class="btn btn-primary">Add New MO</button></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                 </div>
							...
							<tbody>
								<?php
									...
									<tr>
									  ...
									  <td><a href="<?php echo base_url().$controller;?>/edit/<?php echo $test->moid;?>" class="btn btn-success">Edit</a><a onclick="return confirm('Do You Really Delete?');" href="<?php echo base_url().$controller;?>/delete/<?php echo $test->moid;?>" class="btn btn-danger">Delete</a></td>
									  <?php $no++;?>
									</tr>
									<?php
									}
