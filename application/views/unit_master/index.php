...
<div class="container">
    ...
    <button id="btnAdd" class="btn btn-success">Add New Unit</button>
...
<script>
    $(function() {
        ...
        $('#btnAdd').click(function() {
            $('#myModal').modal('show');
            $('#myModal').find('.modal-title').text('Add New Unit');
            $('#myForm').attr('action', '<?php echo base_url() ?>unit/addUnit');
        });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('.alert-success').html('Unit ' + type + ' successfully').fadeIn().delay(4000).fadeOut('slow');
                            showAllUnit();
                        } else {
                            alert('Error');
                        }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('.alert-success').html('Unit Deleted successfully').fadeIn().delay(4000).fadeOut('slow');
                            showAllUnit();
                        } else {
                            alert('Error');
                        }
        ...
        function showAllUnit() {
            $.ajax({
                type: 'ajax',
                url: '<?php echo base_url() ?>unit/showAllUnit',
                async: false,
                dataType: 'json',
                success: function(data) {
                    var html = '';
