	...
	<!-- page content -->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
					...
					<?php echo '<font style="font-size:16px;" color="green">'.$this->session->flashdata('success_msg').'</font>' ?>
                          <input type="hidden" name="mid" value="<?php echo ($action == 'update') ? $row[0]->mid : '';?>">
      ...
      $('.category').select2({
        placeholder: '--- Select Category ---',
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-2 col-sm-6 col-xs-12" for="name">Material Description
                        </label>
                        <div class="col-md-10 col-sm-6 col-xs-12">
                          <input type="text" min="1" id="mdesc" name="mdesc" class="form-control col-md-7 col-xs-12" placeholder="Material Description" value="<?php echo ($action == 'update') ? $row[0]->mdesc : '';?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-2 col-sm-6 col-xs-12" for="name">HSN Code
                        </label>
                        <div class="col-md-10 col-sm-6 col-xs-12">
                          <input type="number" min="1" id="hsn" name="hsn" class="form-control col-md-7 col-xs-12" placeholder="HSN Code" value="<?php echo ($action == 'update') ? $row[0]->hsn : '';?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-6 col-xs-12">
                          <input type="text" min="1" id="mgst" name="mgst" class="form-control col-md-7 col-xs-12" placeholder="GST" value="<?php echo ($action == 'update') ? $row[0]->mgst : '';?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-6 col-xs-12">
                          <input type="number" min="1" id="mbase" name="mbase" class="form-control col-md-7 col-xs-12" placeholder="Base Rate" value="<?php echo ($action == 'update') ? $row[0]->mbase : '';?>">
                        </div>
                      </div>
                      <div class="form-group">
