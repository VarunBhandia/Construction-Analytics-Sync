              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">
					...
					<?php echo '<font style="font-size:16px;" color="green">'.$this->session->flashdata('success_msg').'</font>' ?>
                          <input type="hidden" name="sid" value="<?php echo ($action == 'update') ? $row[0]->sid : '';?>">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-2 col-sm-6 col-xs-12" for="name">Site Start Date
                        </label>
                        <div class="col-md-10 col-sm-6 col-xs-12">
                          <input type="date" min="1" id="sitestartdate" name="sitestartdate" class="form-control col-md-7 col-xs-12" placeholder="Site Start Date" value="<?php echo ($action == 'update') ? $row[0]->sitestartdate : '';?>">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-6 col-xs-12">
                          <input type="text" min="1" id="contact" name="contact" class="form-control col-md-7 col-xs-12" placeholder="Contact Name" value="<?php echo ($action == 'update') ? $row[0]->contactname : '';?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-2 col-sm-6 col-xs-12" for="name">Mobile
                        </label>
                        <div class="col-md-10 col-sm-6 col-xs-12">
                          <input type="number" min="1" id="mobile" name="mobile" class="form-control col-md-7 col-xs-12" placeholder="Mobile Number" value="<?php echo ($action == 'update') ? $row[0]->mobile : '';?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-6 col-xs-12">
                          <input type="text" min="1" id="email" name="email" class="form-control col-md-7 col-xs-12" placeholder="Email-Id" value="<?php echo ($action == 'update') ? $row[0]->email : '';?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-6 col-xs-12">
                          <input type="text" min="1" id="address" name="address" class="form-control col-md-7 col-xs-12" placeholder="Description" value="<?php echo ($action == 'update') ? $row[0]->address : '';?>">
                        </div>
                      </div>
