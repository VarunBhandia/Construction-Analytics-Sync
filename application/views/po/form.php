...
//}
                        ...
                        $(function(){
                            ...
                            var cgst_d = parseFloat(cgst * quantity * unit_price * 0.01)
                            var sgst_d = parseFloat(sgst * quantity * unit_price * 0.01)
                            var igst_d = parseFloat(igst * quantity * unit_price * 0.01)
